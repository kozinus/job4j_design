...
public class User {
    ...
    public static void main(String[] args) {
        ...
        // Пары попали в один бакеты, хэшкоды так же равны.
        // Производилось, они равны, потому что определялись только по полям объектов, а поля у них равны
        // Производилось. Объекты не равны, но бакет и хэшкоды равны, из-за переопределённого hashCode()
    }
